...
fun Routing.index() {
    route("/", HttpMethod.Get) {
        get {
            call.respond(FreeMarkerContent("article.ftl", mapOf(
                "article_author" to "Unnamed User",
                "article_content" to lorem5p,
                "article_published" to "2021-01-01",
                "article_title" to "Super interesting untitled article",
                "article_tags" to listOf("lorem", "ipsum", "dolor", "sit", "amet")))
            )
        }
    }
}